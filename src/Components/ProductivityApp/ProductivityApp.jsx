    ...
    <div className="w-full space-y-5 relative">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button className="productivity-prev btn btn-circle btn-xs lg:btn-sm btn-outline">
            ❮
          </button>
          <button className="productivity-next btn btn-circle btn-xs lg:btn-sm btn-outline">
            ❯
          </button>
        </div>
      </div>
      <Swiper
        ...
        navigation={{
          ...
          nextEl: ".productivity-next",
          prevEl: ".productivity-prev",
        }}
        breakpoints={{
