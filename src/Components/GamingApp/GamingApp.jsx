...
const GamingApp = () => {
  ...
  const gamingApp = appsData.filter((app) => app.category === "Gaming");
  ...
  return (
    <div className="w-full space-y-5 relative">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold">Gaming</h2>

        {/* 3. One-sided Navigation Buttons (Top Right) */}
        <div className="flex gap-2">
          <button className="gaming-prev btn btn-circle btn-xs lg:btn-sm btn-outline">
            ❮
          </button>
          <button className="gaming-next btn btn-circle btn-xs lg:btn-sm btn-outline">
            ❯
          </button>
        </div>
      </div>
